...
#ifndef VOICEFLOW_SWIFT_H
#define VOICEFLOW_SWIFT_H
...
# undef any
# pragma clang attribute push(__attribute__((external_source_symbol(language="Swift", defined_in="VoiceFlow",generated_declaration))), apply_to=any(function,enum,objc_interface,objc_category,objc_protocol))
...
SWIFT_CLASS("_TtC9VoiceFlow11AppDelegate")
...
SWIFT_CLASS("_TtC9VoiceFlow13AudioRecorder")
@interface AudioRecorder : NSObject
- (nonnull instancetype)init OBJC_DESIGNATED_INITIALIZER;
@end

SWIFT_CLASS("_TtC9VoiceFlow17MenuBarController")
...
@class NSCoder;
@class NSWindow;
SWIFT_CLASS("_TtC9VoiceFlow28RecordingHUDWindowController")
@interface RecordingHUDWindowController : NSWindowController
- (nonnull instancetype)init SWIFT_UNAVAILABLE;
+ (nonnull instancetype)new SWIFT_UNAVAILABLE_MSG("-init is unavailable");
...
SWIFT_CLASS("_TtC9VoiceFlow25ReviewHUDWindowController")
@interface ReviewHUDWindowController : NSWindowController
- (nonnull instancetype)init SWIFT_UNAVAILABLE;
+ (nonnull instancetype)new SWIFT_UNAVAILABLE_MSG("-init is unavailable");
- (nullable instancetype)initWithCoder:(NSCoder * _Nonnull)coder OBJC_DESIGNATED_INITIALIZER;
- (void)close;
...
SWIFT_CLASS("_TtC9VoiceFlow24SettingsWindowController")
